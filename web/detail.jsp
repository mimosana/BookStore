                    ...
                    <div class="mt-10 lg:mt-0 flex flex-col h-full">
                        <div class="border-b border-gray-100 pb-8">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="relative">
                                    <select class="block w-full appearance-none rounded-lg border border-gray-200 bg-white py-3 pl-4 pr-10 text-text-main text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary cursor-pointer transition-shadow shadow-sm hover:border-gray-300" id="format-select">
                                        <option selected="" value="hardcover">Hardcover - $13.29</option>
                                        <option value="paperback">Paperback - $9.99</option>
                                        <option value="ebook">Ebook - $8.99</option>
                                        <option value="audiobook">Audiobook - $14.95</option>
                                    </select>
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-4xl">
                        ...
                        <div class="space-y-12">
                            ...
                            <div id="author-content" class="border-t border-gray-200 pt-12 hidden">
                                <h3 class="font-serif text-2xl font-bold text-text-main mb-6">About the Author</h3>
                                <div class="prose prose-gray max-w-none text-text-muted font-light leading-relaxed">
                                    <p class="mb-4">
                                        **Matt Haig** là tác giả người Anh, chuyên viết tiểu thuyết cho cả người lớn và trẻ em. Cuốn sách nổi tiếng nhất của ông là "Reasons to Stay Alive," một cuốn hồi ký bán chạy. "The Midnight Library" là một trong những tác phẩm thành công lớn nhất của ông trong thể loại fiction, khám phá các chủ đề về sự hối tiếc, hy vọng và những lựa chọn trong cuộc sống.
                                    </p>
                                    <p>
                                        Các tác phẩm khác bao gồm "How to Stop Time" và loạt sách thiếu nhi như "A Boy Called Christmas."
                                    </p>
                                </div>
                            </div>

                            <div id="reviews-content" class="border-t border-gray-200 pt-12 hidden">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            tabs.forEach(tab => {
                tab.addEventListener('click', () => {
                    const targetId = tab.dataset.target; // Lấy ID của nội dung mục tiêu từ data-target
                    ...
                    // Cập nhật trạng thái active cho tab (Border và màu chữ)
                    tabs.forEach(t => {
