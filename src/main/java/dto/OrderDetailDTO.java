...
public class OrderDetailDTO {
    ...
    public OrderDetailDTO(int orderDetailId, int orderId, int bookVarId, int quantity, float price) {
    ...
    public OrderDetailDTO(int orderId, int bookVarId, int quantity, float price) {
        this.orderId = orderId;
        this.bookVarId = bookVarId;
        this.quantity = quantity;
        this.price = price;
