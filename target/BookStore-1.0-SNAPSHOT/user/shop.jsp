                                        ...
                                        <c:if test="${not empty listC}">
                                            <div class="filter-group filter-row">
                                                ...
                                                <select name="category" class="custom-select filter-select">
                                                    <option value="all" ${empty category?'selected':""}>Tất cả</option>
                                        ...
                                        <c:if test="${not empty listA}">
                                            <div class="filter-group filter-row">
                                                ...
                                                <select name="author" class="custom-select filter-select">
                                                    <option value="all" ${empty author?'selected':""}>Tất cả</option>
                                                    <c:forEach var="a" items="${listA}">
                                                        <option value="${a.name}" ${author==a.name?'selected':""}>${a.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </c:if>
                                        ...
                                        <c:if test="${not empty listP}">
                                            <div class="filter-group filter-row">
                                                ...
                                                <select name="publisher" class="custom-select filter-select">
                                                    <option value="all" ${empty publisher?'selected':""}>Tất cả</option>
                                                    <c:forEach var="p" items="${listP}">
                                                        <option value="${p.name}" ${publisher==p.name?'selected':""}>${p.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </c:if>
