            ...
            <div class="px-6 lg:px-12 py-4 flex items-center justify-between gap-8">
                ...
                <div class="hidden md:flex flex-1 max-w-lg">
                    <div class="relative w-full group">
                        ...
                        <input class="block w-full pl-12 pr-4 py-3 rounded-full bg-surface-light dark:bg-surface-dark border-none ring-1 ring-inset ring-[#eaf3e7] dark:ring-[#2a3c25] focus:ring-2 focus:ring-primary text-sm transition-shadow shadow-sm" placeholder="Search by title, author, or ISBN..." type="text"/>
                    </div>
                </div>
                <div class="flex items-center gap-4">
                    <nav class="hidden lg:flex items-center gap-6 mr-4">
                        ...
                        <a class="text-sm font-semibold text-text-main dark:text-gray-200 hover:text-primary transition-colors" href="#">Shop</a>
